...
| `08_skin_tension.inc` | Makes agreeing typed surface metrics authoritative, processes vents, checked-writes retained intrados, then applies legacy shaping and creates edges, borders, and layouts |
...
section 1 rib planform + section 2 profiles
  ...
  -> checked intrados write-back after vents, followed by intrados shaping
...
regular-panel development and write-back do not modify it or synthesize
geometry beyond the final rib.
